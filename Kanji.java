...
public class Kanji {
    ...
    public static Quiz getQuiz() {
        try {
            String[] keywords = {
                    "曖昧", "宛先", "畏怖", "萎縮", "椅子", "語彙力", "茨城県", "嗚咽", "怨望", "淑媛", "妖艶", "臆見", "苛禁",
                    "楷則", "諧謔", "蓋世", "樽柿", "亀甲", "破毀", "石臼", "僅僅", "窟穴", "熊襲", "造詣", "空隙", "挙兵", "舷窓",
                    "股肱", "猛虎", "桔梗", "倨傲", "頃合い", "沙羅双樹", "頓挫", "塞源", "刹那", "食餌", "馬鹿", "叱咤",
                    "腫物", "羞恥心", "丼", "比喩", "美貌", "侮蔑", "賭博", "臥薪嘗胆", "葛餅", "提灯", "努々", "片鱗",
                    "払拭", "顛末", "勾配", "冶金"
            };
